          ...
          {managesStock ? (
            ...
            <>
              ...
              <label className="block text-sm text-white/70">
                ...
                <input name="leadTimeDays" type="number" min="0" step="1" defaultValue={fields.leadTimeDays ?? "0"} className="mt-2 w-full rounded-2xl border border-white/10 bg-slate-950/70 px-4 py-3 outline-none focus:border-orange-400/60" />
              </label>
            </>
          )}
